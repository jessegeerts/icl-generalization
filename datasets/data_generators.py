...
class SymbolicDatasetForSampling:
    ...
    Note, the way we use this each integer is a class. so dataset_size is the number of classes.
    """
...
class TransInfSeqGenerator:
    def __init__(self, dataset_for_sampling):
        self.example_type = dataset_for_sampling.example_type
        self.data = dataset_for_sampling.data
        self.classes = sorted(self.data.keys())
