"""
This file contains functions to generate the input sequences for the few-shot learning task of Chan et al, adapted from
Reddy's code to Chan's stimuli.

There are 2 features per stimulus.
feature length: 32
number of classes per feature: 10
number of values per class: 100
covariance scaling: 0.1
number of labels should be 3: 0, 1, 2
"""
...
def generate_input_seqs(mus_label, mus_class, labels_class, S, N, Nmax, eps=0.1, B=0, p_B=0, P=None, p_C=0,
    ...
    K_c = 128  # JPG: number of classes to draw from in the fewshot sequences
