...
from datasets.data_generators import SymbolicDatasetForSampling, SeqGeneratorForTransInf, GaussianDataset
...
if __name__ == '__main__':
    ...
    seqgen = SeqGeneratorForTransInf(dataset,
