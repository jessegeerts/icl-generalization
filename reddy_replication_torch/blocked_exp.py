...
from reddy_replication_torch.blocked_config import config
...
def main(config):
    ...
    for n in range(config.train.niters):
        ...
        inputs_batch, labels_batch, target_classes = generate_input_seqs(mus_label, mus_class, labels_class,
                                                                         ...
                                                                         output_target_labels=True, no_repeats=True, shuffle=config.seq.shuf)
